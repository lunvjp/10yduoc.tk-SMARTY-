...
<div class="mynavbar">
    ...
    <div style="float: right;margin-right:10px;">
        {if isset($admin)}{$admin}{/if}
        {if isset({$smarty.session.info})}{$smarty.session.info}{/if}
    </div>
</div>
...
<div class="content">
    {if isset($successHTML)}{$successHTML}{/if}
    <form method="post" name="update-form" id="update-form">
        <div id="choiceuser">
            {if isset($xhtml)}{$xhtml}{/if}
        </div>
    </form>
    ...
    <div class="form-add-submit" style="position: fixed;"> <!-- Nút cập nhật tại đây -->
        <form method="post" name="form-edit">
            <input hidden id="test" name="test"
                   value="{if isset($smarty.get.testid)}{$smarty.get.testid}{/if}">
